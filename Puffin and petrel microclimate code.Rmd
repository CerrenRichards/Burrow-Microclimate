...
puffin.TNZ<-ggplot(data = ATPU.TNZ, aes(x = Burrow2, y = Inside))+
 ...
 stat_summary( fun.data = "mean_sdl",  fun.args = list(mult = 1), 
  ...
  xlab("Burrow") + ylab("Temperature (°C)")+
  plottheme+
  geom_hline(yintercept = 13.15, colour = "#414487FF", linetype = "dashed", size = 1.3)+
...
# homeothermic puffin (~110g at 10 days old)
43.15 - (6.58*log10(110)) - (0.26*47.267) # = 17.4


# homeothermic petrel (~15g at 5 days old)
43.15 - (6.58*log10(15)) - (0.26*47.267) # = 23.1
