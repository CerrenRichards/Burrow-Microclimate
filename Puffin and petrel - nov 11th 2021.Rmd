...
weather1_forest = "Forested Plot"
weather2_open = "Open Plot"
...
forest_join <- left_join(forest, weather1_forest)
open_join <- left_join(open, weather2_open)
...
# Weather temperature trend
temp <- ggplot(data = weather1_forest, aes(x = DateTime, y = Temperature))+
  geom_line()+
  theme_bw(base_size = 15)+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
  xlab("Date") + ylab("Temperature (°C)")+
...
heat <- ggplot(weather2_open, aes(x = Date, y = Time, fill = Temperature)) +
  theme_bw(base_size = 15)+
  theme(panel.grid.major = element_blank(), # remove the major lines
        panel.grid.minor = element_blank())+
  geom_tile(colour = "white", size = 0.15)+
