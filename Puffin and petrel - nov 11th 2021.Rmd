...
# create the stacked plot
tempall / (corr_puffin + extreme_puffin + corr_petrel + extreme_petrel) + plot_layout(widths=c(2,1))


ggsave("stacked_buffer1.png", 
       dpi = 600, 
       width = 250, height = 300, unit = "mm")


# match the weather data to the internal burrow temps
# sort out the layout of the plots
