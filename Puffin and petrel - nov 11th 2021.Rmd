...
burrows <- burrows %>% select(Species, Burrow, Elevation:Enterance_Area, Distance_from_shore)
...
plot(atpu$Wind.Chill, atpu$Inside)
...
## Save this plot to make the legend
# We will manual move this legend and place it in the plot above with GIMP
