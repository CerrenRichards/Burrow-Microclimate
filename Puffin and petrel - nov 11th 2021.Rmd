...
cpt1[i] <- cpts(cpt.meanvar(x$Inside, method = "BinSeg", Q=2))[1]
cpt2[i] <- cpts(cpt.meanvar(x$Inside, method = "BinSeg", Q=2))[2]
...
# Identify the change points
cpt1[i] <- cpts(cpt.var(x$Inside, method = "BinSeg", Q=3))[1]
cpt2[i] <- cpts(cpt.var(x$Inside, method = "BinSeg", Q=3))[2]
cpt3[i] <- cpts(cpt.var(x$Inside, method = "BinSeg", Q=3))[3]
...
# Heat extreme 2 = 20/30 burrows (67%)
