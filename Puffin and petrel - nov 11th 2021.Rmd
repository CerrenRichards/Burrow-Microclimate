...
```{r}
setwd("/Users/cerren/Desktop/PhD 2021/1. Microclimate temp/2021/Temp data 2021")
...
To investigate inter-nest differences in nest air temperatures,
we used random effects ANOVA, separately for
...
m1 <- lme(temp ~ Burrow, 
    random = ~1|datetime, 
    data=filter(ATPU_LSSP, Species == "Leach's storm-petrel" & Location == "Inside"))
