...
m1_heat_atpu <- lm(data = heat_ATPU, 
                   Buffer ~ volume + Enterance_Area)

summary(m1_heat_atpu)

## PUFFIN - COLD EXTREME
m1_cold_atpu <- lm(data = cold_ATPU, 
                   Buffer ~ volume + Enterance_Area)
...
m1_heat_lssp <- lm(data = heat_LSSP, 
                   Buffer ~ Canopy + volume + Enterance_Area)

summary(m1_heat_lssp)

## PETREL - COLD EXTREME
m1_cold_lssp <- lm(data = cold_LSSP, 
                   Buffer ~  Height + Width + Depth + Enterance_Area + Canopy)
...
m2_heat <- lm(data = heat,
              Buffer ~   Enterance_Area + volume)

summary(m2_heat)

ggplot(heat, aes(x = volume, y = Buffer, group = Species)) +
