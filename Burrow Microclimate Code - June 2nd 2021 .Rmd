...
# Issue when matching up the metadata - need to go back and resolve
# For now, just delete the issue
mean_temp <- mean_temp[-c(49), ]


# Plot
ggplot(mean_temp, aes(x = X, y = mean, group = Location))+
  geom_line()+
